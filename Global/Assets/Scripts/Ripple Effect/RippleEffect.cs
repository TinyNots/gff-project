...
public class RippleEffect : MonoBehaviour
{
    ...
    class Droplet
    {
        ...
        public void Reset(Vector2 pos,float time)
        {
            position = pos;
            life = time;
            time = 0;
        ...
        public void Update()
        {
            ...
            {
                position = new Vector2(9999.0f, 9999.0f);
            }
        }
    ...
    public void Emit(Vector2 pos, float time)
    {
        droplets[dropCount++ % droplets.Length].Reset(pos, time);
    }
